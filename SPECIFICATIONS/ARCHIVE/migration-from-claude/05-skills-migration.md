...
- [x] All skill files migrated from `.claude/skills/` to `.vibe/skills/`
- [x] All skills use Vibe skill format (SKILL.md files with proper frontmatter)
- [x] `.vibe/skills/AGENTS.md` exists and indexes all skills
- [x] Agent spawning adapted to use `task` tool (replaced SpawnAgent)
- [x] Gate logic adapted to Vibe's model (review-gate.md updated)
- [x] `/check-profile-setup` skill created (new skill for profile setup)
- [x] `/setup-profile` skill created (new skill for profile setup guide)
- [x] All internal references updated (/.claude/ → .vibe/) in skill files
...
**Skills Migrated:**
- `review-pr/` - PR review dispatcher → `.vibe/skills/review-pr/SKILL.md`
- `review-pr-team/` - Team review orchestrator → `.vibe/skills/review-pr-team/SKILL.md`
- `review-spec/` - Specification review → `.vibe/skills/review-spec/SKILL.md`
- `review-gate.md` - Gate logic → `.vibe/skills/review-gate.md`
- `post-review-follow-through.md` - Follow-through protocol → `.vibe/skills/post-review-follow-through.md`

**New Skills Created:**
- `check-profile-setup/` - Profile setup check skill
- `setup-profile/` - Profile setup guide skill

**Key Adaptations:**
- **Slash commands → skill() tool**: All `/command` syntax replaced with `skill(name="command")`
- **SpawnAgent → task tool**: All agent spawning converted to use Vibe's `task` tool
- **Hook references → permission system**: References to hooks updated to use Vibe's permission model
- **File paths**: All `.claude/skills/` paths updated to `.vibe/skills/`

### Files Changed

**New Files:**
- `.vibe/skills/review-pr/SKILL.md`
- `.vibe/skills/review-pr-team/SKILL.md`
- `.vibe/skills/review-spec/SKILL.md`
- `.vibe/skills/review-gate.md`
- `.vibe/skills/post-review-follow-through.md`
- `.vibe/skills/check-profile-setup/SKILL.md`
- `.vibe/skills/setup-profile/SKILL.md`
- `.vibe/skills/AGENTS.md` (skills library index)

**Archived Files:**
- All original skills preserved in `.claude/skills/` for backward compatibility

### Verification
- All skills use proper Vibe SKILL.md format with YAML frontmatter
- All agent spawning uses `task` tool with appropriate agent profiles
- All internal references updated to .vibe/ paths
- Skills library index created and maintained

### PR Reference
- **PR #5**: https://github.com/mannepanne/useful-vibe-assets-template/pull/5
- **Commit**: 9a2dc98 - Phase 5: Skills Migration - Convert Claude skills to Vibe skills
