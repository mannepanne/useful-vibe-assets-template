...
This agent's severity ratings are calibrated against the project's threat model — see [`REFERENCE/decisions/2026-04-25-pr-review-threat-model.md`](../../REFERENCE/decisions/2026-04-25-pr-review-threat-model.md) and the shared [Severity calibration](./AGENTS.md#severity-calibration) contract for the full reasoning. The short version:
...
- Read `AGENTS.md` in repository root for architecture, conventions, and security requirements
