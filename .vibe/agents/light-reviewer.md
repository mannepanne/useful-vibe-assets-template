...
Read the project's `AGENTS.md` and `.vibe/AGENTS.md` if they exist — they define the documentation conventions you're checking against.
...
- **ABOUT headers** on any NEW code files (convention in `.vibe/AGENTS.md`: `// ABOUT: …` two-line header). Not required on markdown files.
